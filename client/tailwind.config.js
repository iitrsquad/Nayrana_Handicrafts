...
export default {
  ...
  theme: {
    ...
    extend: {
      // Cross-platform breakpoints for luxury design
      screens: {
      ...
      // Luxury shadows
      boxShadow: {
        'luxury-sm': '0 2px 4px 0 rgba(0, 0, 0, 0.05)',
      ...
      animation: {
        ...
        'pulse-luxury': 'pulse 3s cubic-bezier(0.4, 0, 0.6, 1) infinite',
        'bounce-luxury': 'bounce 2s infinite',
      },
